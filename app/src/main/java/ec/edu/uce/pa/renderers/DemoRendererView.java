...
import ec.edu.uce.pa.utilidades.Point3;
//import com.hlidskialf.android.game.util.MathHelper;
import ec.edu.uce.pa.utilidades.MathHelper;
...
public class DemoRendererView extends GLSurfaceView
{
    ...
    public DemoRendererView(GL10 gl, EGLConfig config)
    {
//        super(context,attrs);
//        mContext = context;

        try{
            mModel = ObjModel.loadFromStream(new FileInputStream("dice.obj"), "mat1_dice.jpg");
